...
# 获取有效 config.sh 链接
get_valid_config() {
    config_list=(https://cdn.jsdelivr.net/gh/yanyuwangluo/tuku@main/huzhu/config.sample.sh https://gitee.com/yanyuwangluo/tuku/raw/main/huzhu/config.sample.sh)
...
# 获取有效 extra.sh 链接
get_valid_extra() {
    extra_list=(https://cdn.jsdelivr.net/gh/yanyuwangluo/tuku@main/huzhu/extra.sh https://gitee.com/yanyuwangluo/tuku/raw/main/huzhu/extra.sh)
...
# 获取有效 code.sh 链接
get_valid_code() {
    code_list=(https://cdn.jsdelivr.net/gh/yanyuwangluo/tuku@main/huzhu/code.sh https://gitee.com/yanyuwangluo/tuku/raw/main/huzhu/code.sh)
...
get_valid_task_before() {
    task_before_list=(https://cdn.jsdelivr.net/gh/yanyuwangluo/tuku@main/huzhu/task_before.sh https://gitee.com/yanyuwangluo/tuku/raw/main/huzhu/task_before.sh)
